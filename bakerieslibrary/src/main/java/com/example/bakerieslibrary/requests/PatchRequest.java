...
public class PatchRequest extends JsonRequest<String> {
    ...
    public PatchRequest(String url, Map<String, String> apiHeaders, String contentType,
                        String entity, Response.Listener<String> listener,
                        Response.ErrorListener errorListener) {
        super(Method.PATCH, url,entity,listener, errorListener);
        mListener = listener;
        this.entity = entity;
